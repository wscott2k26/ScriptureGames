  ...
  return (
    <Tabs
      ...
      screenOptions={{
        ...
        tabBarLabelStyle: { fontSize: 7.6, fontWeight: '900', letterSpacing: 0.05 },
      }}
    >
...
const styles = StyleSheet.create({
  ...
  iconShell: { minWidth: 34, height: 31, borderRadius: 13, alignItems: 'center', justifyContent: 'center' },
